...
// Define the default finish handle for TaskMgr instance.
_proto._finishHandle = function(result) {
...
Object.defineProperty(_proto, 'finish', {
    get: function() {
        return _finishHandle.bind(this);
    },
    set: _finishHandle.bind(this)
});
