...
/*
 * Define the `TaskMgr` Class which aims to manage any numbers of Task instances.
 */
...
_proto.step = function(stepName, stepHandler) {
    ...
    if('string' === typeof stepName) stepHandler = args.shift();
...
/*
 * Define a method which will call when all tasks dnoe.
 * @public
 * @return null
 * @useage:
